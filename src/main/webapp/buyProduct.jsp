					...
					<tr>
						<div id="pDesc">
							...
							<td>
								...
								<p name="pName">
									<c:out value="${currentproduct.getProductName()}" />
								</p> <input name="pUnitPrice" id="price"
								value=" <c:out value="${currentproduct.getStrandardCost()}" />"
								disabled>
								<p name="pQuantity">
									<c:out value="${currentproduct.getQuantity()}" />
								</p>
							</td>
							<td>
								<div id="qty">
